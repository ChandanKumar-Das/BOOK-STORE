...
const Navbar = () => {
  ...
  const navText = (
    <>
      <li>
        <a href="/" className="honer:font-bold"> Home</a>
      </li>
      <li>
      ...
      <div className="navbar ">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 hover:font-bold"
            >
              {navText}
            </ul>
          </div>
        ...
        <div className="navbar-end space-x-3">
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1">{navText}</ul>
          </div>
          ...
          <div className="">
            <a className="btn hover:text-black text-white bg-black"
            onClick={()=>document.getElementById('my_modal_3').showModal()}>Log In
            </a>
            <Login/>
          </div>
        </div>
